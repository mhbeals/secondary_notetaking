...
All comments have been made in scholarly good faith. The reviewed author retains right of rebuttal in this or other fora. Level of detail in notes is a indication in reviewer's immediate interest for on-going projects and *should not* imply that these are the only / most important details presented by the reviewed author.

**This work is licensed under a Creative Commons Attribution 3.0 Unported License.**

\*\*\*Exceptions: Fair Use quotations from the original author's work, duly demarcated above
